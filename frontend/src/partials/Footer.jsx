      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 md:col-span-4 lg:col-span-2">
            <h6 className="text-gray-800 font-medium mb-2">Insurance Cover</h6>
            <ul className="text-sm">
              <li className="mb-2 mb-2 text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">
                Third Party Only
              </li>
              <li className="mb-2 text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">
          ...
          <div className="sm:col-span-6 md:col-span-4 lg:col-span-2">
            ...
            <ul className="text-sm">
              ...
              <li className="mb-2">
                <Link to="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Insurance Cover</Link>
              </li>
              <li className="mb-2">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4"> @2023 <a className="text-blue-600 hover:underline" href="#">Motorchapchap</a>. All rights reserved.</div>
